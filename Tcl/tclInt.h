 ...
 */
   ...
   EXTERN void Tcl_InitStringRep  _ANSI_ARGS_((Tcl_Obj *objPtr,
					       char *bytePtr, int len));

#  define TclNewObj(objPtr) 		       ERROR ERROR ERROR
#  define TclDecrRefCount(objPtr)	       /* Nothing */
#  define TclInitStringRep(objPtr,bytePtr,len) Tcl_InitStringRep(objPtr,bytePtr,len)
#  define TclGetStringFromObj(obj, length)     Tcl_GetStringFromObj((obj),(length))
#  define TclResetObjResult(interp) 	       Tcl_ResetObjResult(interp) 
